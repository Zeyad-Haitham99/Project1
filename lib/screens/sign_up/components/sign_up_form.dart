import 'dart:convert';
import 'package:opera_house/screens/sign_in/components/sign_form.dart';
...
class SignUpForm extends StatefulWidget {
  static String routeName = "/sign up form";
...
class _SignUpFormState extends State<SignUpForm> {
  Future<dynamic> Signupdata() async {
    http.Response response = await http.post(
      Uri.encodeFull("https://cairo-opera.herokuapp.com/submission_customer"),
      headers: {
